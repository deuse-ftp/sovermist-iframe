        ...
        <div style={{
            ...
            {isConnected && (
                <div style={{ marginBottom: '20px' }}>
                    ...
                    <p style={{ color: '#fff', marginTop: '10px' }}>If the message ''Loading game for the first time'' appears, press F5 and please wait </p> {/* Nova mensagem */}
            ...
            {isConnected && !networkError && (
                <iframe
                    frameBorder="0"
                    src="https://itch.io/embed-upload/14561001?color=333333"
                    allowFullScreen
                    width="1280"
                    height="740"
