...
import { ApiController, ConnectionController, ConnectorController, ConstantsUtil as CoreConstantsUtil, EventsController, PublicStateController, SIWXUtil, getPreferredAccountType } from '@reown/appkit-controllers';
    ...
    createAuthProvider(chainNamespace) {
        ...
        if (!this.authProvider && this.options?.projectId && isAuthEnabled) {
            this.authProvider = W3mFrameProviderSingleton.getInstance({
                ...
                getActiveCaipNetwork: (namespace) => ChainController.getActiveCaipNetwork(namespace)
            });
