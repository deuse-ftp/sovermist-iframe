...
function createSecureSiteSdkUrl({ projectId, chainId, version, enableLogger, rpcUrl = ConstantsUtil.BLOCKCHAIN_API_RPC_URL }) {
...
export class W3mFrame {
    constructor({ projectId, isAppClient = false, chainId = 'eip155:1', enableLogger = true, rpcUrl = ConstantsUtil.BLOCKCHAIN_API_RPC_URL }) {
        this.iframe = null;
