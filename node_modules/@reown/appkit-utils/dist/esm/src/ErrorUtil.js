...
export const ErrorUtil = {
    ...
    ALERT_ERRORS: {
        ...
        ORIGIN_NOT_ALLOWED: {
            ...
            longMessage: () => `🔧 Origin ${isSafe() ? window.origin : 'unknown'} not found on allow list. Please update your project configurations on dashboard.reown.com.`
        },
        IFRAME_LOAD_FAILED: {
        ...
        SERVER_ERROR_APP_CONFIGURATION: {
            ...
            longMessage: (errorMessage) => `Failed to get App Configuration ${errorMessage || ''}`
        },
