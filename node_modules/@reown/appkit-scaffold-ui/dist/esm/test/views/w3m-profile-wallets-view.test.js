...
import { AccountController, ChainController, ConnectionController, ConnectionControllerUtil, ConnectorController, CoreHelperUtil, OptionsController, RouterController, SnackController, StorageUtil } from '@reown/appkit-controllers';
...
const mockBitcoinAddress = 'bip122:000000000019d6689c085ae165831e93:bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh';
...
describe('W3mProfileWalletsView - Basic Rendering', () => {
    beforeEach(() => {
        ...
        vi.spyOn(ChainController, 'getAccountData').mockReturnValue({
            caipAddress: mockEthereumAddress,
    ...
    it('should render basic structure with header and connections', async () => {
        ...
        const element = await fixture(html `<w3m-profile-wallets-view></w3m-profile-wallets-view>`);
...
describe('W3mProfileWalletsView - Active Profile Rendering', () => {
    ...
    it('should render active profile when connector and address exist', async () => {
        ...
        expect(activeProfile?.getAttribute('address')).toBe('0x1234567890123456789012345678901234567890');
    });
...
describe('W3mProfileWalletsView - Connections List', () => {
    ...
    it('should render active connections list', async () => {
        ...
        const element = await fixture(html `<w3m-profile-wallets-view></w3m-profile-wallets-view>`);
        const inactiveProfiles = element.shadowRoot?.querySelectorAll('[data-testid="active-connection"]');
    ...
    it('should render recent connections with correct labels', async () => {
        ...
        const element = await fixture(html `<w3m-profile-wallets-view></w3m-profile-wallets-view>`);
        await element.updateComplete;
        const recentConnectionsText = element.shadowRoot?.querySelector('[data-testid="recently-connected-text"]');
    ...
    it('should render correct button labels for active vs recent connections', async () => {
        ...
        const element = await fixture(html `<w3m-profile-wallets-view></w3m-profile-wallets-view>`);
        const activeConnections = element.shadowRoot?.querySelectorAll('[data-testid="active-connection"]');
        const recentConnections = element.shadowRoot?.querySelectorAll('[data-testid="recent-connection"]');
...
describe('W3mProfileWalletsView - Bitcoin Specific Behavior', () => {
    beforeEach(() => {
        ...
        vi.spyOn(ChainController, 'getAccountData').mockReturnValue({
            caipAddress: mockBitcoinAddress
        });
    });
...
describe('W3mProfileWalletsView - Empty State', () => {
    ...
    it('should not render add connection button when connections exist', async () => {
        ...
        const addConnectionItem = element.shadowRoot?.querySelector('[data-testid="add-connection-button"]');
...
describe('W3mProfileWalletsView - User Actions', () => {
    ...
    it('should handle disconnect all action', async () => {
        const element = await fixture(html `<w3m-profile-wallets-view></w3m-profile-wallets-view>`);
        const disconnectAllLink = element.shadowRoot?.querySelector('[data-testid="disconnect-all-button"]');
    ...
    it('should handle add connection action', async () => {
        const element = await fixture(html `<w3m-profile-wallets-view></w3m-profile-wallets-view>`);
        const addConnectionButton = element.shadowRoot?.querySelector('[data-testid="add-connection-button"]');
    ...
    it('should handle copy address action', async () => {
        ...
        expect(CoreHelperUtil.copyToClopboard).toHaveBeenCalledWith('0x1234567890123456789012345678901234567890');
...
describe('W3mProfileWalletsView - Loading States', () => {
    ...
    it('should show loading state when switching account', async () => {
        ...
        let resolveSwitchConnection;
        const switchConnectionPromise = new Promise(resolve => {
        ...
        const loadingWallet = Array.from(walletItems || []).find(item => item.loading === true);
...
//# sourceMappingURL=w3m-profile-wallets-view.test.js.map