...
import { ApiController, BlockchainApiController, ChainController, OnRampController, OptionsController } from '../../exports/index.js';
...
describe('OnRampController', () => {
    ...
    it('should properly configure meld url', () => {
        ...
        OnRampController.resetState();
        const meldProvider = ONRAMP_PROVIDERS[0];
