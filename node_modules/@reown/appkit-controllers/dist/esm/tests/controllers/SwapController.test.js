...
import { AccountController, BlockchainApiController, ChainController, ConnectionController, ConnectorController, RouterController, SwapController } from '../../exports/index.js';
...
describe('SwapController', () => {
    ...
    it('should replace SwapPreview view when approval transaction is approved', async () => {
        ...
        vi.spyOn(RouterController, 'pushTransactionStack').mockImplementationOnce(() => Promise.resolve());
        const onEmbeddedWalletApprovalSuccessSpy = vi.spyOn(SwapController, 'onEmbeddedWalletApprovalSuccess');
