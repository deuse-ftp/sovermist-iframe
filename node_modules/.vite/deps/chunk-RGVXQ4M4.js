import {
  ConnectorUtil,
  WalletUtil
} from "./chunk-HVKHDHJT.js";
import {
  W3mFrameHelpers,
  W3mFrameProvider
} from "./chunk-OB6JWWLI.js";
import {
  CaipNetworksUtil,
...
var W3mFrameProviderSingleton = class _W3mFrameProviderSingleton {
  ...
  static getInstance({ projectId, chainId, enableLogger, onTimeout, abortController, getActiveCaipNetwork }) {
      ...
      switch (error.message) {
        ...
        case "SERVER_ERROR": {
          ...
          AlertController.open({
            ...
            longMessage: ErrorUtil.ALERT_ERRORS.SERVER_ERROR_APP_CONFIGURATION.longMessage(originalError.message)
          }, "error");
          break;
        }
        default:
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-LERWB7WQ.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-O5G2OLXT.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-FCI4WR6U.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-TQXWWMN4.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-KDO2NESG.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-MSWNJ4LL.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-BQQNYZGX.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-JZZMBW4V.js"));
    }
    if (features.pay) {
      featureImportPromises.push(import("./exports-YYT5M2LP.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-H2YKCPRC.js"),
      import("./w3m-modal-7Q3MQXIC.js")
    ]);
  }
};

// node_modules/@reown/appkit/dist/esm/exports/constants.js
var PACKAGE_VERSION = "1.7.15";
...
//# sourceMappingURL=chunk-RGVXQ4M4.js.map
