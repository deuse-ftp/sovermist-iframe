...
function br(t, e, n3, r2 = {}) {
  return n3?.sort((o2, i3) => o2.localeCompare(i3)), { att: { [t]: He(e, n3, r2) } };
}
function He(t, e, n3 = {}) {
...
function Ic(t) {
  ...
  const { ProjectivePoint: a2, normPrivateKeyToScalar: u3, weierstrassEquation: l4, isWithinCurveOrder: f7 } = Ac({ ...e, toBytes(g, w3, b5) {
    ...
    if (w3 === o2 && (b5 === 2 || b5 === 3)) {
      const R5 = Ot(I4);
      if (!Ee(R5, K, n3.ORDER)) throw new Error("Point is not on curve");
      const x2 = l4(R5);
      let C6;
      try {
        C6 = n3.sqrt(x2);
...
function qc(t, e) {
  const n3 = Se({ encoded: t, encoding: e?.encoding });
  return oo({ type: Bt(n3.type), senderPublicKey: typeof n3.senderPublicKey < "u" ? toString(n3.senderPublicKey, G) : void 0, receiverPublicKey: e?.receiverPublicKey });
}
function oo(t) {
  const e = t?.type || dn;
  if (e === Ft) {
...
function ha(t, e) {
  let n3 = null;
  return nt(t?.publicKey, false) || (n3 = ht("MISSING_OR_INVALID", `${e} controller public key should be a string`)), n3;
}
function mn(t) {
  let e = true;
...
function Ao(t, e) {
  let n3 = null;
  return mn(t?.methods) ? mn(t?.events) || (n3 = Nt("UNSUPPORTED_EVENTS", `${e}, events should be an array of strings or empty array for no events`)) : n3 = Nt("UNSUPPORTED_METHODS", `${e}, methods should be an array of strings or empty array for no methods`), n3;
}
function wn(t, e) {
  let n3 = null;
  return Object.values(t).forEach((r2) => {
...
var vi2 = class {
  constructor(e, t, i3) {
    this.core = e, this.logger = t, S2(this, "name", Tt2), S2(this, "keychain"), S2(this, "randomSessionIdentifier", jc()), S2(this, "initialized", false), S2(this, "init", async () => {
      ...
      return Vc({ type: l4, symKey: h4, message: c3, senderPublicKey: d3, encoding: o2?.encoding });
      ...
      try {
        const c3 = this.getSymKey(s), h4 = Mc({ symKey: c3, encoded: n3, encoding: o2?.encoding });
...
var qn = class extends m {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, V2(this, "events", new import_events3.EventEmitter()), V2(this, "name", At2), V2(this, "queue", /* @__PURE__ */ new Map()), V2(this, "publishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), V2(this, "initialPublishTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), V2(this, "needsTransportRestart", false), V2(this, "publish", async (i3, s, n3) => {
      ...
      const a2 = n3?.ttl || je2, c3 = Zc(n3), h4 = n3?.prompt || false, l4 = n3?.tag || 0, d3 = n3?.id || getBigIntRpcId().toString(), g = { topic: i3, message: s, opts: { ttl: a2, relay: c3, prompt: h4, tag: l4, id: d3, attestation: n3?.attestation, tvf: n3?.tvf } }, _2 = `Failed to publish payload, please try again. id:${d3} tag:${l4}`;
      try {
        const u3 = new Promise(async (b5) => {
          ...
          const I4 = yi(new Promise((D3, j3) => {
            this.rpcPublish({ topic: i3, message: s, ttl: a2, prompt: h4, tag: l4, id: d3, attestation: n3?.attestation, tvf: n3?.tvf }).then(D3).catch((T3) => {
...
var Ti2 = class extends P {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, f5(this, "subscriptions", /* @__PURE__ */ new Map()), f5(this, "topicMap", new Hn()), f5(this, "events", new import_events3.EventEmitter()), f5(this, "name", Ut), f5(this, "version", Ft2), f5(this, "pending", /* @__PURE__ */ new Map()), f5(this, "cached", []), f5(this, "initialized", false), f5(this, "storagePrefix", B), f5(this, "subscribeTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_MINUTE)), f5(this, "initialSubscribeTimeout", (0, import_time2.toMiliseconds)(import_time2.ONE_SECOND * 15)), f5(this, "clientId"), f5(this, "batchSubscribeTopicsLimit", 500), f5(this, "init", async () => {
      ...
      try {
        const n3 = Zc(s), o2 = { topic: i3, relay: n3, transportType: s?.transportType };
...
var Li2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, p2(this, "name", Mt2), p2(this, "version", Kt2), p2(this, "events", new import_events3.default()), p2(this, "pairings"), p2(this, "initialized", false), p2(this, "storagePrefix", B), p2(this, "ignoredPayloadTypes", [Ft]), p2(this, "registeredMethods", []), p2(this, "init", async () => {
      ...
      this.isInitialized();
      const s = jc(), n3 = await this.core.crypto.setSymKey(s), o2 = Ei(import_time2.FIVE_MINUTES), a2 = { protocol: xt2 }, c3 = { topic: n3, expiry: o2, relay: a2, active: false, methods: i3?.methods }, h4 = Wc({ protocol: this.core.protocol, version: this.core.version, topic: n3, symKey: s, relay: a2, expiryTimestamp: o2, methods: i3?.methods });
...
var Te = class _Te extends h2 {
  constructor(e) {
    ...
    const s = k({ level: typeof e?.logger == "string" && e.logger ? e.logger : Et2.logger, name: he2 }), { logger: n3, chunkLoggerController: o2 } = A({ opts: s, maxSizeInBytes: e?.maxLogBlobSizeInBytes, loggerOverride: e?.logger });
...
var Ee3 = class _Ee extends J {
  constructor(n3) {
    ...
    }), this.name = n3?.name || me2.name, this.metadata = oi(n3?.metadata), this.signConfig = n3?.signConfig;
    const e = typeof n3?.logger < "u" && typeof n3?.logger != "string" ? n3.logger : (0, import_pino.default)(k({ level: n3?.logger || me2.logger }));
    this.core = n3?.core || new Xo2(n3), this.logger = E(e, this.name), this.session = new St3(this.core, this.logger), this.proposal = new Os2(this.core, this.logger), this.pendingRequest = new bs2(this.core, this.logger), this.engine = new Ns2(this), this.auth = new Ls2(this.core, this.logger);
  }
...
var B2 = class _B {
  constructor(t) {
    l3(this, "client"), l3(this, "namespaces"), l3(this, "optionalNamespaces"), l3(this, "sessionProperties"), l3(this, "scopedProperties"), l3(this, "events", new import_events7.default()), l3(this, "rpcProviders", {}), l3(this, "session"), l3(this, "providerOpts"), l3(this, "logger"), l3(this, "uri"), l3(this, "disableProviderPing", false), this.providerOpts = t, this.logger = typeof t?.logger < "u" && typeof t?.logger != "string" ? t.logger : (0, import_pino.default)(k({ level: t?.logger || et2 })), this.disableProviderPing = t?.disableProviderPing || false;
  }
  static async init(t) {
    const e = new _B(t);
    return await e.initialize(), e;
...
var D2 = async () => {
  const { createAppKit: s } = await import("./core-CNFUDWWG.js");
  return s;
};
...
function G3(s) {
  ...
  const c3 = { chains: t, methods: n3 || f6, events: a2 || C5, rpcMap: v4({}, t.length ? { [I3(t)]: u3[I3(t)] } : {}) }, l4 = a2?.filter((d3) => !C5.includes(d3)), r2 = n3?.filter((d3) => !f6.includes(d3));
  if (!e && !o2 && !i3 && !(l4 != null && l4.length) && !(r2 != null && r2.length)) return { required: t.length ? c3 : void 0 };
  const m2 = l4?.length && r2?.length || !e, h4 = { chains: [...new Set(m2 ? c3.chains.concat(e || []) : e)], methods: [...new Set(c3.methods.concat(i3 != null && i3.length ? i3 : A4))], events: [...new Set(c3.events.concat(o2 != null && o2.length ? o2 : P3))], rpcMap: u3 };
...
var b4 = class _b {
  ...
  async connect(t) {
    ...
    try {
      const a2 = await new Promise(async (u3, c3) => {
        ...
        await this.signer.connect(w2(v4({ namespaces: v4({}, n3 && { [this.namespace]: n3 }) }, i3 && { optionalNamespaces: { [this.namespace]: i3 } }), { pairingTopic: t?.pairingTopic, scopedProperties: m2 })).then((h4) => {
          u3(h4);
        }).catch((h4) => {
          var d3;
  ...
  getRpcConfig(t) {
    var e, n3;
    const i3 = (e = t?.chains) != null ? e : [], a2 = (n3 = t?.optionalChains) != null ? n3 : [], o2 = i3.concat(a2);
    if (!o2.length) throw new Error("No chains specified in either `chains` or `optionalChains`");
    const u3 = i3.length ? t?.methods || f6 : [], c3 = i3.length ? t?.events || C5 : [], l4 = t?.optionalMethods || [], r2 = t?.optionalEvents || [], m2 = t?.rpcMap || this.buildRpcMap(o2, t.projectId), h4 = t?.qrModalOptions || void 0;
    return { chains: i3?.map((d3) => this.formatChainId(d3)), optionalChains: a2.map((d3) => this.formatChainId(d3)), methods: u3, events: c3, optionalMethods: l4, optionalEvents: r2, rpcMap: m2, showQrModal: !!(t != null && t.showQrModal), qrModalOptions: h4, projectId: t.projectId, metadata: t.metadata };
  }
  buildRpcMap(t, e) {
    const n3 = {};
    return t.forEach((i3) => {
  ...
  loadConnectOpts(t) {
    ...
    })), n3 && se(n3) && (this.rpc.optionalChains = [], this.rpc.optionalChains = n3?.map((a2) => this.formatChainId(a2)), n3.forEach((a2) => {
      this.rpc.rpcMap[a2] = i3?.[a2] || this.getRpcUrl(a2);
    }));
  }
  getRpcUrl(t, e) {
...
*/
//# sourceMappingURL=index.es-QFZU3WON.js.map
