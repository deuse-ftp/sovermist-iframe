...
// node_modules/@base-org/account/dist/interface/builder/core/wagmiConnector.js
function baseAccountConnector(parameters) {
  let walletProvider;
  let accountsChanged;
  let chainChanged;
  let disconnect;
  return createConnector((config2) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK: createBaseAccountSDK2 } = await import("./dist-VFGFWPCJ.js");
        const sdk = createBaseAccountSDK2(Object.assign(Object.assign({}, parameters), { appChainIds: config2.chains.map((x) => x.id), preference }));
        ...
        if (error.code === 4902) {
          try {
            ...
            if (addEthereumChainParameter === null || addEthereumChainParameter === void 0 ? void 0 : addEthereumChainParameter.blockExplorerUrls)
              ...
              blockExplorerUrls = ((_a = chain.blockExplorers) === null || _a === void 0 ? void 0 : _a.default.url) ? [(_b = chain.blockExplorers) === null || _b === void 0 ? void 0 : _b.default.url] : [];
            let rpcUrls;
...
function createEphemeralSDK(chainId) {
...
async function executePaymentWithSDK(requestParams, testnet) {
  const network = testnet ? "baseSepolia" : "base";
...
//# sourceMappingURL=dist-VFGFWPCJ.js.map
